...
public class AdminController {
	...
	@GetMapping("/member")
	public ResponseEntity<Map> adminMemberList(@RequestParam(defaultValue = "1") int reqPage,
	...
	/* 영화 목록 */
	@GetMapping("/movie")
	public ResponseEntity<Map> adminMovieList(@RequestParam(required = false) Integer reqPage,
			@RequestParam(required = false) String movieTitle, @RequestParam(required = false) Integer movieStatus) {
	...
	public ResponseEntity<Integer> updateMovieStatus(@PathVariable int movieNo, @RequestPart("movie") MovieDTO movie) {
	...
	public List<Map<String, String>> getOccupiedTimes(@RequestParam int screenNo, @RequestParam String scheduleOpen) {
